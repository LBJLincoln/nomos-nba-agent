...
class Individual:
    ...
    def __init__(self, n_features, target=100, model_type=None):
        ...
        self.hyperparams = {
            ...
            "calibration": random.choices(["none", "sigmoid", "venn_abers", "beta", "lr_meta", "lr_platt", "isotonic_temporal"], weights=[11, 12, 22, 22, 9, 10, 14], k=1)[0],  # cycle97: 2x isotonic_temporal (MDPI2026 ~0.199 Brier LR+isotonic)
    ...
    def mutate(self, rate=0.03, feature_importance=None):
        ...
        if random.random() < 0.05: self.hyperparams["calibration"] = random.choices(["none", "sigmoid", "venn_abers", "beta", "lr_meta", "lr_platt", "isotonic_temporal"], weights=[9, 12, 25, 20, 9, 10, 15], k=1)[0]  # cycle97: 2x isotonic_temporal weight
